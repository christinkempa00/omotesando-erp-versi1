...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-5"
    ...
    <div>
        ...
        <select name="type" required class="w-full rounded-md border-gray-300 shadow-sm focus:border-gold-500 focus:ring-gold-500">
            ...
            <template x-for="(item, index) in items" :key="index">
                <div class="flex items-center gap-2">
                    <input type="text" :name="`checklist[${index}]`" x-model="items[index]"
                           ...
                           class="flex-1 rounded-md border-gray-300 shadow-sm focus:border-gold-500 focus:ring-gold-500">
    ...
    <div class="sm:col-span-2">
        ...
        <textarea name="notes" rows="3"
                  class="w-full rounded-md border-gray-300 shadow-sm focus:border-gold-500 focus:ring-gold-500">{{ old('notes', $job->notes ?? '') }}</textarea>
    </div>
</div>
