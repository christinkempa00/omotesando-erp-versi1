                        ...
                        @forelse ($records as $record)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-right text-sm">
                                    <a href="{{ route('ga.uniforms.records.show', $record) }}" class="text-indigo-600 hover:text-indigo-900 font-medium">Detail</a>
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="7" class="px-6 py-8 text-center text-sm text-gray-500">Belum ada catatan serah-terima.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
