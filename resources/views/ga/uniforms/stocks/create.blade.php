<x-app-layout>
    <x-slot name="header">
        <div>
            ...
            <h2 class="font-semibold text-xl text-ink leading-tight">Tambah Varian Seragam</h2>
        </div>
    </x-slot>
                ...
                <form method="POST" action="{{ route('ga.uniforms.stocks.store') }}" enctype="multipart/form-data"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <select name="branch_id" required @change="branchId = $event.target.value; branchLocationId = ''" class="w-full rounded-md border-gray-300 shadow-sm focus:border-gold-500 focus:ring-gold-500">
                    ...
                    <div class="mt-6 border border-gray-200 rounded-lg p-4"
                        ...
                        <div class="flex items-center justify-between mb-1">
                            ...
                            <button type="button" @click="addRow()" class="text-xs font-medium text-gold-600 hover:text-gold-700">
                                Buat Ukuran
                            </button>
                        </div>
