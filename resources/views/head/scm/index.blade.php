<x-app-layout sidebar="head">
    ...
    <div class="py-8">
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <x-filter-bar :action="route('head.scm.index')" :search="false" :reset-url="route('head.scm.index')">
                <div>
            ...
            <div class="bg-white shadow-sm rounded-lg overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100">
                    <h3 class="font-medium text-gray-800">Pengiriman</h3>
                </div>
                ...
                <div class="px-6 py-3 border-t border-gray-100">{{ $deliveryNotes->links() }}</div>
            </div>

            <div class="bg-white shadow-sm rounded-lg overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100">
                    <h3 class="font-medium text-gray-800">Laporan Selisih</h3>
                </div>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 text-sm">
                        <thead class="bg-gray-50">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            @forelse ($discrepancies as $report)
                                <tr>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="px-6 py-8 text-center text-gray-500">Belum ada selisih tercatat.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
                <div class="px-6 py-3 border-t border-gray-100">{{ $discrepancies->links() }}</div>
            </div>
