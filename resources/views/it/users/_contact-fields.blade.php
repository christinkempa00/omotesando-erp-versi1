...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
    ...
    <div>
        ...
        <select name="division_id" class="w-full px-3.5 py-2.5 border border-gray-300 rounded-lg text-sm focus:border-accent focus:ring-2 focus:ring-accent">
    ...
    <div>
        ...
        <select name="branch_id" class="w-full px-3.5 py-2.5 border border-gray-300 rounded-lg text-sm focus:border-accent focus:ring-2 focus:ring-accent">
            <option value="">-- Tidak ada --</option>
