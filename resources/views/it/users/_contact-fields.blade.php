...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
    ...
    <div>
        ...
        <select name="division_id" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
    ...
    <div>
        <label class="block text-sm font-medium text-gray-700 mb-1">Branch / Outlet</label>
