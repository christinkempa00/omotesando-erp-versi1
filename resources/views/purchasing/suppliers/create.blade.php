                ...
                <form method="POST" action="{{ route('purchasing.suppliers.store') }}">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea name="address" rows="2" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('address') }}</textarea>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Termin Pembayaran (hari)</label>
                            <input type="number" name="payment_terms_days" min="0" value="{{ old('payment_terms_days') }}"
                                   class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        </div>
                    </div>
