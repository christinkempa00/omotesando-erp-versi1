    ...
    <x-slot name="header">
        <div>
            ...
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Purchase Order Baru — Barang Umum
            </h2>
        </div>
    </x-slot>
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('purchasing.purchase-orders.store') }}"
                      x-data="{ items: {{ Illuminate\Support\Js::from(old('items', [['item_name' => '', 'qty' => 1, 'unit' => 'Pcs', 'unit_price' => '']])) }} }">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Tujuan (Branch) *</label>
                    ...
                    <div>
                        ...
                        <button type="button" @click="items.push({ item_name: '', qty: 1, unit: 'Pcs', unit_price: '' })"
